...
-- インデックス
CREATE INDEX watched_plan_id_idx ON watched(plan_id);
CREATE INDEX watched_user_id_idx ON watched(user_id);
...
-- ===========================================
-- ビュー: 投稿詳細（リアクション数・コメント数・鑑賞済み数含む）
-- ===========================================
